...
const RECTS=[Rect2(848,277,496,64),Rect2(848,361,496,56),Rect2(848,435,496,56),Rect2(848,509,238,56),Rect2(1106,509,238,56),Rect2(848,589,496,44)]
...
static func draw(hud) -> void:
	...
	var labels=["DEVAM ET  →","YENİ DENEME" if hud.game.training else "KADRO & TAKTİK","AYARLAR","ANTRENMAN" if hud.game.training else "HIZLI MAÇ","ANA MENÜ","KONTROL REHBERİ"]
	...
	if hud.game.controller.using_gamepad: hud.pad_hints(Vector2(850,694),[["LS / D-PAD","Gez"],["A","Seç"],["B","Devam"]],27,13)
	else: hud.text("YÖN TUŞLARI · Gez     ENTER · Seç     ESC · Devam",Vector2(848,705),12,UI.MUTE)
